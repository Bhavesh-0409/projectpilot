...
app/
  ...
  capabilities/
    ...
    github_intel.py           GitHub repo analysis, exact-path source-file reads, + deterministic health score
    artifact.py               README/diagram generation
  memory/store.py            SQLite-backed per-session history + last-artifact persistence
  eval/
