...
so a rule-based score is used instead of an LLM opinion.
...
notifications or emails, executing arbitrary code, and any action that
would write to an external system. These are documented future-work items,
